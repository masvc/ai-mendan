...
generate_both "q5" "株式会社安心の絆で働くことに興味を持ってくれた理由を教えてくれる？"
generate_both "q6" "チームで働くとき、意識していることは？"
generate_both "q7" "これまでの経験の中で、成長できたと感じた瞬間ってある？"
generate_both "q8" "株式会社安心の絆で、どんな働き方をしてみたい？希望があれば聞かせて。"
...
generate_both "complete1" "今日はお話を聞かせてくれて、ありがとう！あなたの想いは、スタッフがきちんと目を通すよ。"
generate_both "complete2" "2日以内に連絡するから、少しだけ待っててね。不安なことがあれば、いつでも気軽に聞いてね。"
